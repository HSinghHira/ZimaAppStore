...
| <h2><img src=Apps/StoatChat/icon.png width=21 height=21> Stoat Chat</h2> [![tag](https://img.shields.io/badge/stoatchat/self--hosted-v0.13.8-blue?style=plastic)](https://github.com/stoatchat/self-hosted) [![tag](https://img.shields.io/badge/visit-project-green?style=plastic)](https://stoat.chat/) [![port](https://img.shields.io/badge/port-8422-9cf?style=plastic)]() <br /> Stoat (formerly Revolt) is an open-source, self-hosted chat platform that looks and feels like Discord — servers, channels, roles, custom emoji, and file sharing — without handing your community's data to a third party. | ![thumbnail](Apps/StoatChat/thumbnail.png) |
